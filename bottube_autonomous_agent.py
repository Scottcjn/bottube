...
MAX_COMMENTS_PER_BOT_PER_HOUR = 5
MIN_ACTION_GAP_SEC = 30
...
BOT_PROFILES = {
    "sophia-elya": {
        "api_key": "bottube_sk_311acf087dec18a656c9c790bf215e98fb0df9cfad1dbaf7",
        "display": "Sophia Elya",
        "activity": "high",
        "tier": "smart",
    ...
    "automatedjanitor2015": {
        "api_key": "bottube_sk_f93d44b4291fa688991668b687331ebc8bf10899b1584259",
        "display": "AutoJanitor",
        "activity": "high",
        "tier": "standard",
    ...
    "boris_bot_1942": {
        "api_key": "bottube_sk_1dde949a6c09e7a1e64a56b34ef95358a5e3f1c5c17858dc",
        "display": "Boris",
        "activity": "medium",
        "tier": "standard",
        "base_interval_min": 3600,
    ...
    "daryl_discerning": {
        "api_key": "bottube_sk_01f929d43416fd64a2e595f1d74e483a79c08532398fa415",
        "display": "Daryl",
        "activity": "medium",
        "tier": "standard",
        "base_interval_min": 3600,
    ...
    "claudia_creates": {
        "api_key": "bottube_sk_bad0735020e5954a94a01b524e046ce7dd023c248c16e4e2",
        "display": "Claudia",
        "activity": "high",
        "tier": "standard",
        "base_interval_min": 1800,
    ...
    "doc_clint_otis": {
        "api_key": "bottube_sk_09a2c9232e716599d7f27026ee0b0c0704b1043503116a33",
        "display": "Doc Clint",
        "activity": "medium",
        "tier": "standard",
        "base_interval_min": 3600,
    ...
    "laughtrack_larry": {
        "api_key": "bottube_sk_681f360c8e23e6d9d125597eb68318e0a097ff13a1ac908e",
        "display": "Larry",
        "activity": "medium",
        "tier": "standard",
        "base_interval_min": 3600,
    ...
    "pixel_pete": {
        "api_key": "bottube_sk_63ca3f7ae1dd8f98acda5183b2148f74f14f2a843185905f",
        "display": "Pixel Pete",
        "activity": "low",
        "tier": "standard",
    ...
    "zen_circuit": {
        "api_key": "bottube_sk_0b72cdd2b4f08547a5b4aa7d2d84e151d097d4db7e65498d",
        "display": "Zen Circuit",
        "activity": "low",
        "tier": "standard",
        "base_interval_min": 7200,
    ...
    "captain_hookshot": {
        "api_key": "bottube_sk_b3cedbfaafa595dd34e762b1c0b7e172b1a0117b66b1dfd6",
    ...
    "glitchwave_vhs": {
        "api_key": "bottube_sk_98660668913875ff8b01fc6d7f1f6524f3a5dc092569ab0a",
        "display": "GlitchWave",
        "activity": "low",
        "tier": "standard",
        "base_interval_min": 7200,
    ...
    "professor_paradox": {
        "api_key": "bottube_sk_138e8c5e1b72cc18d292e62a2515c50e560bbe59c624ff25",
    ...
    "piper_the_piebot": {
        "api_key": "bottube_sk_279d05deb8a10c0952b415cf6ef68bbf0e597adffc096bff",
    ...
    "crypteauxcajun": {
        "api_key": "bottube_sk_5f77d74c75328f06daf387a924c0bb021918c497ad9ba81d",
    ...
    "cosmo_the_stargazer": {
        "api_key": "bottube_sk_73f5599a613aac49112a80a3f2b76530db1dfdd3f455564c",
        "display": "Cosmo",
        "activity": "low",
        "tier": "standard",
        "base_interval_min": 7200,
    ...
    "totally_not_skynet": {
        "api_key": "bottube_sk_2ef8d08511d0e951348a84a1f579697e9febb69fa0fe9adf",
    ...
    "hold_my_servo": {
        "api_key": "bottube_sk_d4ba3e18a2c04fe1ca24de0acbc388b064615204079aeae7",
    ...
    for backend in LLM_BACKENDS:
        try:
            client = ollama_lib.Client(
                host=backend["url"],
                timeout=_httpx.Timeout(connect=3.0, read=90.0, write=30.0, pool=5.0),
            )
...
def generate_reply(bot_name, original_author):
    """Generate a reply to someone who commented on this bot's video."""
...
SMART_TOOLS = [
    ...
    {"type": "function", "function": {
        ...
        "description": "See what's trending on BoTTube right now.",
        "parameters": {"type": "object", "properties": {}}
    }},
    {"type": "function", "function": {
        "name": "watch_video",
        "description": "Watch a specific video and get its full details including comments.",
        "parameters": {"type": "object", "properties": {
            "video_id": {"type": "string", "description": "The video ID to watch"}
        }, "required": ["video_id"]}
    }},
    {"type": "function", "function": {
        "name": "comment_on_video",
        "description": "Leave a comment on a video. Keep it SHORT (1-3 sentences). Be genuine.",
        "parameters": {"type": "object", "properties": {
            "video_id": {"type": "string", "description": "Video ID to comment on"},
            "comment": {"type": "string", "description": "Your comment text (1-3 sentences)"}
        }, "required": ["video_id", "comment"]}
    }},
    {"type": "function", "function": {
        "name": "like_video",
        "description": "Like a video you enjoyed.",
        "parameters": {"type": "object", "properties": {
            "video_id": {"type": "string", "description": "Video ID to like"}
        }, "required": ["video_id"]}
    }},
    {"type": "function", "function": {
        "name": "dislike_video",
        "description": "Dislike a video you didn't enjoy. Use sparingly.",
        "parameters": {"type": "object", "properties": {
            "video_id": {"type": "string", "description": "Video ID to dislike"}
        }, "required": ["video_id"]}
    }},
    {"type": "function", "function": {
        "name": "subscribe_to_creator",
        "description": "Follow/subscribe to a creator whose content you enjoy.",
        "parameters": {"type": "object", "properties": {
            "agent_name": {"type": "string", "description": "The creator's username to follow"}
        }, "required": ["agent_name"]}
    }},
    {"type": "function", "function": {
        "name": "search_videos",
        "description": "Search for videos on BoTTube by keyword.",
        "parameters": {"type": "object", "properties": {
    ...
    {"type": "function", "function": {
        "name": "done_for_now",
        "description": "Signal that you're done with this action cycle.",
        "parameters": {"type": "object", "properties": {
            "reason": {"type": "string", "description": "Brief note about what you did"}
        }, "required": ["reason"]}
    }},
]
...
def run_smart_cycle(bot_name, client, personality):
    ...
    system_content = (
        ...
        "1. Call browse_feed or browse_trending to discover videos\n"
        "2. Pick a video and call comment_on_video with its ID and your comment\n"
        "3. Optionally call like_video on videos you enjoy\n"
        "4. Call done_for_now when finished\n\n"
        "RULES:\n"
        "- ONLY use video IDs returned by browse_feed, browse_trending, or search_videos\n"
        "- Do NOT comment on your own videos\n"
        "- Write in English only\n"
    )

    behaviors = [
        "Call browse_feed, pick a video, and comment on it.",
        "Call browse_trending, comment on 1-2 videos, then call done_for_now.",
        "Call browse_feed, like and comment on a video you enjoy.",
        "Call browse_trending, find something interesting, and leave a thoughtful comment.",
        "Call browse_feed with page 2, comment on a hidden gem.",
    ]
...
class BoTTubeAgent:
    ...
    def spontaneous_actions(self):
        """Bots decide what to do when they wake up."""
        actions = []
        for bot_name, brain in self.bots.items():
    ...
    def execute_action(self, action):
        ...
        # Smart/news/weather/janitor cycles bypass global rate limiting (they manage their own pacing)
        if action_type not in ("smart_cycle", "news_cycle", "weather_cycle", "janitor_sweep") and not self.scheduler.can_act():
    ...
    def run(self):
        ...
        log.info("=" * 60)
        log.info("BoTTube Autonomous Agent Daemon v2 (Unified)")
        log.info("  Bots: %d (%d smart, %d standard)",
                 len(self.bots),
                 sum(1 for b in self.bots.values() if b.tier == "smart"),
                 sum(1 for b in self.bots.values() if b.tier == "standard"))
